...
function procesarPedido() {
    ...
    if (!nombre || !direccion) {
        alert("Por favor, llena tu nombre y direccion antes de continuar.");
        return;
    }
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    if (el) {
        var visitasSimuladas = localStorage.getItem('visitas_lalito') || Math.floor(Math.random() * 30) + 20;
